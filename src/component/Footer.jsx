  ...
  return (
    <div>
      <div className="bg-dark text-light pt-3">
          ...
          <div className="container mt-3">
            <a href="/" className="navbar-brand">
              <div className="text-light d-flex align-items-center">
                <img src={free} style={{ width: "200px", height: "200px" }} alt="logo" />
              </div>
            </a>
          </div>
        ...
        <div className="p-3 d-flex justify-content-center">{/* <p>Copyright © 2000-2002 MilanTV. All Rights Reserved</p> */}</div>
      </div>
    </div>
  );
};
