...
const Detailpage = () => {
  ...
  const { detail, inLoading } = useSelector((state) => state?.gamedetail?.detailGame);
  console.log(detail);
  useEffect(() => {
    ...
    <div>
      <div>
        ...
        <div style={{ margin: "50px 0" }}>
          <img style={{ width: "100vw", margin: "50px 0" }} src={detail?.background_image} alt=""></img>
          <img style={{ width: "100vw" }} src={detail?.background_image_additional} alt=""></img>
        </div>
      </div>
    </div>
  );
